...
public class AddressControllerTest {
    ...
    public void setup() throws JsonProcessingException {
        ...
        this.addressForm.setStreet("Street name");
        this.addressForm.setCity("City name");
        this.addressForm.setZipCode("00000-000");
        this.addressForm.setUf("AC");
        this.addressForm.setCountry("Country");
